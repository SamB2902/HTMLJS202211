...
var CheckeredLine = new Image();
CheckeredLine.src = "images/CheckeredLine.png";
var MushroomKingdom = new Image();
MushroomKingdom.src = "images/MushroomKingdom.jpg";
...
function drawStartFinish(){
   ...
   // ctx.fillRect(start, 50, 10, 500);
    ctx.drawImage(CheckeredLine,start, 50, 150, 500)
    //finish line
    //ctx.fillRect(finish, 50, 10, 500);
    ctx.drawImage(CheckeredLine,finish, 50, -150, 500)
...
function drawCar(){
    //draw a car
   // ctx.fillStyle = "red";
    //ctx.fillRect(carPos, canvas.height / 2, carWidth, 30);
...
function drawFuelBar(){
    ...
    ctx.fillStyle = "black";
    //ctx.fillRect(start, 30, fuelBarWidth, 20);
    ctx.drawImage(MushroomKingdom,start, 30, fuelBarWidth, 30)
    ctx.font = "25px Impact";
    ctx.fillText("Fuel", start, 25);
    if (fuel > 0) {
        ctx.fillStyle = "green";
        ctx.fillRect(start, 30, currentBarWidth, 30);
    }
}
